...
class Unet_CQT_oct_with_attention(nn.Module):
    ...
    def __init__(self, args, device):
        ...
        args=EasyDict(args) #convert to EasyDict for easier access
        self.args=args
        ...
        self.CQTransform=CQT_nsgt(self.args.network.cqt.num_octs, self.args.network.cqt.bins_per_oct, mode="oct",window=win,fs=self.args.exp.sample_rate, audio_len=self.args.audio_len, dtype=torch.float32, device=self.device)
